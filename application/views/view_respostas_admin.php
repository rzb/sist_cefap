...
<?php $this->load->view('respostas_opcoes_admin'); ?>
...
{
	echo "<h2>Avaliações finalizadas</h2>";
	echo "<table id='view_respostas' class='tabela1 tabela_estilo1'>";
	echo "<thead>";
	echo "<tr>";
	echo "<th>ID</th>";
	...
	foreach($resp as $i => $u)
	{
		...
		echo "<li class='op_reabriravaliacao'><a title='Reabrir avaliação' href='" . base_url('respostas/reabrir/' . $u->id) . "'>Reabrir avaliacao</a></li>";
		echo "</ul></td>";
